<template>
	<div class="graph-total">Total: <span class="graph-total__data">{{ graphObj.totalRobux }}</span></div>
					...
					tooltip: {
						...
						callbacks: {
							...
							label: function(tooltipItem) { 
								return  `Payout: $${props.graphObj.graphData[tooltipItem.dataIndex].payoutAmount} / Topup: $${props.graphObj.graphData[tooltipItem.dataIndex].topupAmount}`
							}
						},
						xAlign: 'center',
						yAlign: 'bottom',
